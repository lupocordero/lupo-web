...
export const UI = {
  ...
  de: {
    readMore: 'Weiterlesen', relatedPosts: 'Weiterlesen', faqTitle: 'Häufig gestellte Fragen', ctaHeading: 'Lass uns reden', ctaBody: 'Schreib mir, was du dir vorstellst — ich antworte noch am selben Tag.', ctaButton: 'Auf WhatsApp schreiben', formName: 'Name', formEmail: 'E-Mail', formSessionType: 'Art des Shootings', formMessage: 'Nachricht', formSubmit: 'Senden', areasWeWork: 'Wo ich arbeite', servicesHeading: 'Spezialisierung', secondaryHeading: 'Außerdem', commercialHeading: 'Kommerzielle Arbeiten', reelsHeading: 'Neueste Arbeiten', langSwitch: 'Sprache', blogListTitle: 'Journal', publishedOn: '', checkAvailability: 'Verfügbarkeit anfragen', modalBody: 'Schreib mir Datum und Art des Shootings — ich antworte noch am selben Tag.', modalClose: 'Schließen',
  },
  en: {
...
export const HOME_SERVICE_BLURBS = {
  ...
  events: {
    ...
    de: 'Familienfeiern, Firmenevents und private Feiern.',
    en: 'Family celebrations, corporate events and private parties.',
  },
  realestate: {
